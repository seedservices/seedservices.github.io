const translations = {
  en: {
    ...
    "hero.card.title": "Project Cloverlight",
    "hero.card.body":
      "A kinetic adventure about luck, choice, and improbable friends. Demo drops soon.",
  ...
  "zh-HK": {
    ...
    "hero.card.title": "Project Cloverlight",
    "hero.card.body": "關於幸運、選擇與意外朋友的動感冒險。Demo 即將推出。",
